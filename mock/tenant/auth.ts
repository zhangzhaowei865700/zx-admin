...
let adminMenuData: MenuRecord[] = [
  {
    ...
    permission: 'dashboard', clientType: 'admin', type: 2, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00',
  },
  {
    ...
    children: [
      { id: 21, parentId: 2, name: '订单列表', path: '/order/list', component: 'pages/order/index', permission: 'order:list', clientType: 'admin', type: 2, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00',
        children: [
          { id: 211, parentId: 21, name: '查看', permission: 'order:list:view', clientType: 'admin', type: 3, sort: 0, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 212, parentId: 21, name: '新增订单', permission: 'order:list:create', clientType: 'admin', type: 3, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 213, parentId: 21, name: '编辑订单', permission: 'order:list:update', clientType: 'admin', type: 3, sort: 2, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 214, parentId: 21, name: '删除订单', permission: 'order:list:delete', clientType: 'admin', type: 3, sort: 3, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
        ],
      },
    ],
  },
  {
    ...
    children: [
      { id: 31, parentId: 3, name: '商品列表', path: '/product/list', component: 'pages/product/index', permission: 'product:list', clientType: 'admin', type: 2, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00',
        children: [
          { id: 311, parentId: 31, name: '查看', permission: 'product:list:view', clientType: 'admin', type: 3, sort: 0, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 312, parentId: 31, name: '新增商品', permission: 'product:list:create', clientType: 'admin', type: 3, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 313, parentId: 31, name: '编辑商品', permission: 'product:list:update', clientType: 'admin', type: 3, sort: 2, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 314, parentId: 31, name: '删除商品', permission: 'product:list:delete', clientType: 'admin', type: 3, sort: 3, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
        ],
      },
    ],
  },
  {
    ...
    permission: 'setting', clientType: 'admin', type: 2, sort: 4, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00',
    children: [
      { id: 41, parentId: 4, name: '查看', permission: 'setting:view', clientType: 'admin', type: 3, sort: 0, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
      { id: 42, parentId: 4, name: '修改设置', permission: 'setting:update', clientType: 'admin', type: 3, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
    ],
  },
  {
    id: 5, parentId: 0, name: '系统管理', path: '/system', icon: 'SettingOutlined', clientType: 'admin',
    permission: 'system', type: 1, sort: 5, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00',
    children: [
      { id: 51, parentId: 5, name: '用户管理', path: '/system/user', icon: 'UserOutlined', component: 'pages/system/user', permission: 'system:user', clientType: 'admin', type: 2, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00',
        children: [
          { id: 511, parentId: 51, name: '查看', permission: 'system:user:view', clientType: 'admin', type: 3, sort: 0, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 512, parentId: 51, name: '新增用户', permission: 'system:user:create', clientType: 'admin', type: 3, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 513, parentId: 51, name: '编辑用户', permission: 'system:user:update', clientType: 'admin', type: 3, sort: 2, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 514, parentId: 51, name: '删除用户', permission: 'system:user:delete', clientType: 'admin', type: 3, sort: 3, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
        ],
      },
      { id: 52, parentId: 5, name: '角色管理', path: '/system/role', icon: 'SafetyCertificateOutlined', component: 'pages/system/role', permission: 'system:role', clientType: 'admin', type: 2, sort: 2, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00',
        children: [
          { id: 521, parentId: 52, name: '查看', permission: 'system:role:view', clientType: 'admin', type: 3, sort: 0, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 522, parentId: 52, name: '新增角色', permission: 'system:role:create', clientType: 'admin', type: 3, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 523, parentId: 52, name: '编辑角色', permission: 'system:role:update', clientType: 'admin', type: 3, sort: 2, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 524, parentId: 52, name: '删除角色', permission: 'system:role:delete', clientType: 'admin', type: 3, sort: 3, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
        ],
      },
      { id: 53, parentId: 5, name: '菜单管理', path: '/system/menu', icon: 'MenuOutlined', component: 'pages/system/menu', permission: 'system:menu', clientType: 'admin', type: 2, sort: 3, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00',
        children: [
          { id: 531, parentId: 53, name: '查看', permission: 'system:menu:view', clientType: 'admin', type: 3, sort: 0, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 532, parentId: 53, name: '新增菜单', permission: 'system:menu:create', clientType: 'admin', type: 3, sort: 1, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 533, parentId: 53, name: '编辑菜单', permission: 'system:menu:update', clientType: 'admin', type: 3, sort: 2, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
          { id: 534, parentId: 53, name: '删除菜单', permission: 'system:menu:delete', clientType: 'admin', type: 3, sort: 3, visible: 1, status: 1, createdAt: '2025-01-01 10:00:00' },
        ],
      },
    ],
  },
